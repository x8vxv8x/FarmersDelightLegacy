...
public class BlockFluidloggedRice extends BlockWaterloggedPlant implements IGrowable {
    ...
    public boolean canBlockStay(World worldIn, BlockPos pos, IBlockState state) {
        ...
        return this.canSustainBush(soilState) && this.hasContainedWater(worldIn, pos, state);
    }
